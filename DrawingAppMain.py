...
color_box=PhotoImage(file="ColorSelector.png")
Label(root,image=color_box,bg="#f2f3f5").place(x=10,y=20)


eraser=PhotoImage(file="eraser.png")
Button(root,image=eraser,bg="#f2f3f5",command=new_canvas,height=30,width=30).place(x=30,y=400)
